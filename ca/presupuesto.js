...
form.addEventListener('submit', async (e) => {
  ...
  if (faltan.length > 0) {
    avisar('Omple l\'empresa, el teu nom, el correu i quants comptes necessiteu.');
  ...
  if (ficha && respuesta === null) {
    $('reto').dataset.mal = 'si';
    avisar('Falta la comprovació de sota: toca la resposta correcta.');
  ...
  try {
    ...
    if (!respuestaHttp.ok) {
      ...
      avisar(cuerpo?.error || 'No hem pogut enviar la teva petició. Torna-ho a provar o escriu-nos a soporte@micarga.es.');
    ...
    avisar('No ens hem pogut connectar. Comprova la connexió, o escriu-nos a soporte@micarga.es i t\'ho preparem igualment.');
  } finally {
